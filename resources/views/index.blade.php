			...
			<div class="p-relative">
				<section id="downloads" class="section section-parallax m-0" data-plugin-parallax data-plugin-options="{'speed': 1.5}" data-image-src="img/demos/app-landing/parallax/downloads-parallax.png" style="background-color: #781e20;">
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<h2 class="custom-bar _left _color-light text-color-black">AGENDE SUA CONSULTA</h2>
				...
				<img src="https://acasaqueaminhavoqueria.com/wp-content/uploads/2016/01/CALENDARIO-MES-janeiro-a-casa-que-a-minha-vo-queria.png" data-appear-animation="fadeInRight" data-appear-animation-delay="300" data-plugin-options="{'accY': 200}" alt="" class="custom-product-image-pos-2 _litle-big img-fluid d-none d-lg-block" />
			</div>
